 ...
 *
 * ServeTask is provided to ember-cli using our cluster-master / cluster-worker primitives from ember-alt-fastboot-app-server in development
 */
class CustomServeTask extends ServeTask {
  ...
  run(options) {
    ...
    assert(options.port != options.liveReloadPort,
